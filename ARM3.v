...
//    assign Real_StallW = StructuralStall; // Freeze WB
    // 集成cache暂停
assign Real_StallF = StallF || StructuralStall || cache_busy;
assign Real_StallD = StallD || StructuralStall || cache_busy;
assign Real_StallE = StructuralStall || cache_busy;
assign Real_StallM = StructuralStall || cache_busy;
assign Real_StallW = StructuralStall || cache_busy;
    // ******************************************************
    //              PIPELINE STAGES
    // ******************************************************
